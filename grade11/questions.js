 ...
 * Universal key mapping to guarantee compatibility with all controller variants.
 */
...
const datasetA = [
  ...
  // --- DIFFICULT ROUND ---
  { round: "Difficult Round", points: 5, timer: 30, type: "text", question: "What optical phenomenon allows light signals to travel inside fiber optic cables without escaping?", answer: "total internal reflection", acceptableAnswers: ["total internal reflection", "internal reflection"] },
  { round: "Difficult Round", points: 5, timer: 30, type: "text", question: "What detergent chemical additive causes algal blooms and oxygen depletion in rivers?", answer: "phosphate", acceptableAnswers: ["phosphate", "phosphates"] },
  { round: "Difficult Round", points: 5, timer: 30, type: "text", question: "What rotational force causes an object to turn or rotate around a pivot or fulcrum?", answer: "torque", acceptableAnswers: ["torque"] },
  { round: "Difficult Round", points: 5, timer: 30, type: "text", question: "What upward force is exerted by a fluid on an object placed in it according to Archimedes' principle?", answer: "buoyant force", acceptableAnswers: ["buoyant force", "buoyancy"] },
  { round: "Difficult Round", points: 5, timer: 30, type: "text", question: "What hollow hull design allows massive metal ships to float by increasing displaced water volume?", answer: "density", acceptableAnswers: ["density", "buoyancy", "volume"] },
  ...
  { round: "Clincher Round", points: 5, timer: 30, type: "text", question: "What heating process eliminates pathogens in dairy products without boiling the liquid?", answer: "pasteurization", acceptableAnswers: ["pasteurization"] },
  ...
  { round: "Clincher Round", points: 5, timer: 30, type: "text", question: "What primary surfactant compound ingredient in soap molecules lifts nonpolar oil?", answer: "fatty acid", acceptableAnswers: ["fatty acid", "fatty acids", "surfactant"] },
...
const datasetB = [
  ...
  // --- DIFFICULT ROUND ---
  { round: "Difficult Round", points: 5, timer: 30, type: "text", question: "What simple machine component acts as a fixed pivot point about which a lever rotates?", answer: "fulcrum", acceptableAnswers: ["fulcrum"] },
  { round: "Difficult Round", points: 5, timer: 30, type: "text", question: "What class of hazardous metals like lead and cadmium leach into groundwater from improper battery disposal?", answer: "heavy metals", acceptableAnswers: ["heavy metals", "heavy metal"] },
  { round: "Difficult Round", points: 5, timer: 30, type: "text", question: "What safety device automatically breaks an electric circuit when current amperage exceeds safe limits?", answer: "circuit breaker", acceptableAnswers: ["circuit breaker"] },
  { round: "Difficult Round", points: 5, timer: 30, type: "text", question: "Which medical innovation uses focused, coherent light waves for precise tissue incisions?", answer: "laser", acceptableAnswers: ["laser", "lasers"] },
  { round: "Difficult Round", points: 5, timer: 30, type: "text", question: "What fluid property describes a liquid's resistance to flow and internal friction?", answer: "viscosity", acceptableAnswers: ["viscosity"] },
  ...
  { round: "Clincher Round", points: 5, timer: 30, type: "text", question: "What fundamental property of matter resists changes in its state of linear motion?", answer: "inertia", acceptableAnswers: ["inertia"] },
  ...
  { round: "Clincher Round", points: 5, timer: 30, type: "text", question: "What light wave frequency band is used by remote controls and thermal sensors?", answer: "infrared", acceptableAnswers: ["infrared", "infrared wave", "ir"] },
...
const datasetC = [
  ...
  // --- DIFFICULT ROUND ---
  { round: "Difficult Round", points: 5, timer: 30, type: "text", question: "What additive in personal care soaps acts as a chelating agent to soften hard water?", answer: "edta", acceptableAnswers: ["edta"] },
  { round: "Difficult Round", points: 5, timer: 30, type: "text", question: "What wave interaction causes noise-canceling headphones to reduce background sound?", answer: "destructive interference", acceptableAnswers: ["destructive interference"] },
  { round: "Difficult Round", points: 5, timer: 30, type: "text", question: "What physical property of a body resists changes in its rotational state of motion?", answer: "rotational inertia", acceptableAnswers: ["rotational inertia", "moment of inertia"] },
  { round: "Difficult Round", points: 5, timer: 30, type: "text", question: "What heating process eliminates disease-causing pathogens in milk and fruit juices?", answer: "pasteurization", acceptableAnswers: ["pasteurization"] },
  { round: "Difficult Round", points: 5, timer: 30, type: "text", question: "What simple machine consists of a wheel with a groove holding a rope or cable?", answer: "pulley", acceptableAnswers: ["pulley"] },

  // --- CLINCHER ROUND ---
  { round: "Clincher Round", points: 5, timer: 30, type: "text", question: "What standard warning pictograms on cleaning products communicate toxicity and flammability?", answer: "ghs", acceptableAnswers: ["ghs", "globally harmonized system"] },
  ...
  { round: "Clincher Round", points: 5, timer: 30, type: "text", question: "What optical wave property causes light bending when entering water from air?", answer: "refraction", acceptableAnswers: ["refraction"] },
...
// Universal mapping object to match ANY dropdown string
export const rawQuestionBank = new Proxy({
  "Question Set A": datasetA,
  "Question Set B": datasetB,
  "Question Set C": datasetC,
  "Set A": datasetA,
  "Set B": datasetB,
  "Set C": datasetC,
  "A": datasetA,
  ...
  get: function(target, prop) {
    ...
    // Fallback to Set A if unmatched
    return datasetA;
  }
});

export const questions = datasetA;
