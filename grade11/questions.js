 ...
 * Formatted specifically for Grade 11 Controller dropdown sets & round counters.
 */
...
export const rawQuestionBank = {
  "A": [
    ...
    // --- DIFFICULT ROUND (Preserved Original Identification / Text Format) ---
...
rawQuestionBank[1] = rawQuestionBank["A"];
rawQuestionBank[2] = rawQuestionBank["B"];
rawQuestionBank[3] = rawQuestionBank["C"];

export const questions = rawQuestionBank["A"];
